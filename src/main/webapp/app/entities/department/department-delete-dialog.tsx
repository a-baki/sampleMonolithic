...
export const DepartmentDeleteDialog = (props: IDepartmentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sampleMonolithicApp.department.delete.question">
        <Translate contentKey="sampleMonolithicApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
