...
export const EmployeeDeleteDialog = (props: IEmployeeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sampleMonolithicApp.employee.delete.question">
        <Translate contentKey="sampleMonolithicApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
