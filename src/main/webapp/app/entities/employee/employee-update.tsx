  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="sampleMonolithicApp.employee.home.createOrEditLabel">
            <Translate contentKey="sampleMonolithicApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : employeeEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="firstNameLabel" for="employee-firstName">
                  <Translate contentKey="sampleMonolithicApp.employee.firstName">First Name</Translate>
                </Label>
                <AvField id="employee-firstName" type="text" name="firstName" />
                <UncontrolledTooltip target="firstNameLabel">
                  <Translate contentKey="sampleMonolithicApp.employee.help.firstName" />
                </UncontrolledTooltip>
              </AvGroup>
              <AvGroup>
                <Label id="lastNameLabel" for="employee-lastName">
                  <Translate contentKey="sampleMonolithicApp.employee.lastName">Last Name</Translate>
                </Label>
                <AvField id="employee-lastName" type="text" name="lastName" />
              </AvGroup>
              <AvGroup>
                <Label id="emailLabel" for="employee-email">
                  <Translate contentKey="sampleMonolithicApp.employee.email">Email</Translate>
                </Label>
              ...
              <AvGroup>
                <Label id="hireDateLabel" for="employee-hireDate">
                  <Translate contentKey="sampleMonolithicApp.employee.hireDate">Hire Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="salaryLabel" for="employee-salary">
                  <Translate contentKey="sampleMonolithicApp.employee.salary">Salary</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="employee-manager">
                  <Translate contentKey="sampleMonolithicApp.employee.manager">Manager</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="employee-department">
                  <Translate contentKey="sampleMonolithicApp.employee.department">Department</Translate>
                </Label>
