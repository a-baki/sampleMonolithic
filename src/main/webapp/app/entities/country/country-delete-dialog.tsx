...
export const CountryDeleteDialog = (props: ICountryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sampleMonolithicApp.country.delete.question">
        <Translate contentKey="sampleMonolithicApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
