...
export const JobHistoryDeleteDialog = (props: IJobHistoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sampleMonolithicApp.jobHistory.delete.question">
        <Translate contentKey="sampleMonolithicApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
