...
export const LocationDeleteDialog = (props: ILocationDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="sampleMonolithicApp.location.delete.question">
        <Translate contentKey="sampleMonolithicApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
